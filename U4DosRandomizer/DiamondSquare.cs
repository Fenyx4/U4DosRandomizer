// Taken from https://gist.github.com/awilki01/83b65ad852a0ab30192af07cda3d7c0b
...
namespace U4DosRandomizer
{
    public class DiamondSquare
    {
        ...
        public double[,] getData(int randomSeed)
        {
        ...
        private double[,] diamondSquareAlgorithm(Random r)
        {
            ...
            //Random r = new Random(randomSeed);//for the new value in range of h
